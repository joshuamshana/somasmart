  ...
  theme: {
    extend: {
      colors: {
        ...
        "collection-hover": "rgb(var(--collection-hover) / <alpha-value>)",
        "collection-selected": "rgb(var(--collection-selected) / <alpha-value>)",
        "collection-selected-border": "rgb(var(--collection-selected-border) / <alpha-value>)",
        "collection-muted": "rgb(var(--collection-muted) / <alpha-value>)",
        "section-tab-bg": "rgb(var(--section-tab-bg) / <alpha-value>)",
        "section-tab-hover": "rgb(var(--section-tab-hover) / <alpha-value>)",
        "section-tab-active-bg": "rgb(var(--section-tab-active-bg) / <alpha-value>)",
        "section-tab-active-border": "rgb(var(--section-tab-active-border) / <alpha-value>)",
        "context-strip-bg": "rgb(var(--context-strip-bg) / <alpha-value>)",
        "rail-surface": "rgb(var(--rail-surface) / <alpha-value>)",
