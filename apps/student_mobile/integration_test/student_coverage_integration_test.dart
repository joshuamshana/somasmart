...
void main() {
  ...
  group('Student coverage journeys', () {
    testWidgets('REQ-0101/0201/0302/0601: register -> lessons -> quiz -> progress', (tester) async {
    ...
    testWidgets('REQ-0204/0702: locked lesson unlock via coupon', (tester) async {
      final repo = FakeAppRepository();
      await _pumpApp(tester, repo);
    ...
    testWidgets('REQ-1701/1102: notifications and manual sync status', (tester) async {
      final repo = FakeAppRepository();
      await _pumpApp(tester, repo);
    ...
    testWidgets('REQ-0901/1802: support page minor gate', (tester) async {
      final repo = FakeAppRepository();
      await _pumpApp(tester, repo);
    ...
    testWidgets('REQ-2202/2203: appearance theme preference', (tester) async {
      final repo = FakeAppRepository();
      await _pumpApp(tester, repo);
